...
- (void)viewDidLoad
{
    ...
    if (list == nil)
    {
        NSMutableArray *array = [[NSMutableArray alloc] initWithObjects:
                                 ...
                                 @"Во прва година сите студенти се запишуваат на Академски студии по информатика. Во рамките на студиите се следат задолжителни предмети кои се во рамки на 50% од програмата. Од третиот семестар на студии се почнува со изборни предмети кои го формираат остатокот од програмата. Изборните предмети формираат модули кои ја дефинираат специјалноста на студентот и дипломата со која ќе се стекне. Покрај предметите од модулот студентот може да избира од цела низа дополнителни изборни предмети. Студентот сам го прави својот избор соодветно на неговите интереси.\n\nКомпјутерски науки\nМодулот овозможува образување инженери кои ќе стекнат широки теориски и програмски знаења и ќе можат да се вклучат во развојот и имплементацијата на софтвер како и развој на информатиката како наука и нејзината примена во останатите научни области давајќи им добри основи за адаптација на нови технологии и нивна примена.\n\nИнформациски системи\nМодулот овозможува образување на инженери кои ќе можат да ги анализираат информациските потреби на деловните субјекти, да дефинираат и дизајнираат системи со кои ќе се интегрираат решенијата што ги нудат информациските технологии и деловните процеси за да се реализираат информациските потреби на деловните субјекти на ефикасен и задоволителин начин.\n\nПрограмско инженерство\nМодулот образува инженери кои ќе можат да дизајнираат и правилно да применат широк ранг на софтвер и софтверски системи, организираат и управуваат со софтверските проекти. Длабокото запознавање со комплетниот процес на создавање софтверски продукт, овозможува знаење со кое студентите веднаш по дипломирањето можат да се вклучат во ИТ индустријата (вработување или сопствен бизнис).\n\nКомпјутерски архитектури и мрежи\nМодулот образува инженери кои ќе се стекнат со знаење и вештини да се справат со архитектурата и организацијата на компјутерите и компјутерските мрежи, како и дизајнирање, поставување, остварување и заштита на податочните и компјутерските комуникации.",
